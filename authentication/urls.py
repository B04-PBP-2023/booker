...
from authentication.views import UserSignUp, UserSignUpMobile, AdminSignUp, login_user, logout_user, login_mobile, logout_mobile, check_is_anonymous, get_user_data
...
urlpatterns = [
    ...
    path('signup-mobile/', UserSignUpMobile.as_view(), name='signup_mobile'),
