...
from reviewbuku.serializers import BookReviewSerializer
from rest_framework.renderers import JSONRenderer
from book.models import Book, BorrowedBook, BoughtBook, BorrowedBookSerializer, BoughtBookSerializer, BookSerializer
...
def add_review(request):
    if request.method == 'POST':
        ...
        book_review = BookReview(rating=rating, review_text=review_text, book_id=book_id, user=request.user)
        book_review.save()
