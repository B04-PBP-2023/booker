...
from reviewbuku.views import show_review_buku, get_review_json, add_review, tambah_poin, ubah_rating, get_borrow_json, get_bought_json, get_book_json, get_review_json_flutter, create_product_flutter
...
urlpatterns = [
    ...
    path('get-review-json-flutter/', get_review_json_flutter,
         name='get_review_json_flutter'),
